      ...
      <section className="bg-white rounded-3xl p-8 shadow-sm border border-stone-100 relative overflow-hidden group">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <button className="flex items-center gap-2 bg-white hover:bg-stone-50 text-stone-700 px-6 py-3 rounded-full font-bold border border-stone-200 transition-all">
              <Star size={20} />
              Favoritar
            </button>
          </div>
